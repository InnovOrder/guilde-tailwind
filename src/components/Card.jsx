...
const Card = () => {
    return (
        <div className="rounded-lg overflow-hidden border w-full lg:w-6/12 md:w-6/12 bg-white mx-3 md:mx-2 lg:mx-1 shadow-xl">
            ...
            <img alt="profilepic" className="w-full bg-cover" src="https://3.bp.blogspot.com/-Chu20FDi9Ek/WoOD-ehQ29I/AAAAAAAAK7U/mc4CAiTYOY8VzOFzBKdR52aLRiyjqu0MwCLcBGAs/s1600/DSC04596%2B%25282%2529.JPG" />
            <div className="px-3 pb-2 my-2">
                <div className="pt-2">
                    <i className="far fa-heart cursor-pointer"></i>
                    <span className="text-sm text-gray-400 font-medium border-8 border-indigo-600 rounded p-2">❤️ 12 likes</span>
                </div>
                <div className="pt-1">
